    ...
    <div className="header">
        ...
        <div className="skills">
          ...
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 128 128" width="32" height="32">
            ...
            <path fill="#EBEBEB" d="M64 52.455H45.788L44.53 38.361H64V24.599H29.489l.33 3.692 3.382 37.927H64zm0 35.097l-.061.017-15.327-4.14-.979-10.975H33.816l1.928 21.609 28.193 7.822.063-.017z"/>
            <path fill="#FFFFFF" d="M63.952 52.455v13.763h16.947l-1.597 17.938-15.35 4.143v14.241l28.215-7.82.207-2.326 3.234-36.233.335-3.739h-3.708zm0-27.856v13.762h33.244l.276-3.092.628-6.978.329-3.692z"/>
          </svg>            
          <h2>HTML</h2>
          </div>
          <div className="skill">
